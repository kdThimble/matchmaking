                        ...
                        child: Center(
                          child: TableCalendar(
                            ...
                            headerStyle: HeaderStyle(
                              ...
                              leftChevronIcon: Icon(Icons.chevron_left, color: Color(0xFF3C4FDF)),
                              rightChevronIcon: Icon(Icons.chevron_right, color: Color(0xFF3C4FDF)),
                            ...
                            calendarStyle: CalendarStyle(
                              ...
                              selectedDecoration: BoxDecoration(
                                shape: BoxShape.circle,
                                color: Color(0xFF3C4FDF), // Color for selected dates
                              ),
                            ...
                            child: Column(
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Text(
                                    _selectedTime1 != null
                                        ? _selectedTime1!.format(context)  // Display the selected time
                                        : 'End Time',
                                    style: TextStyle(
                                      color: Color(0xFF667085),
                                      fontSize: 30,
